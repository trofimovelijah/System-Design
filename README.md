...
2. Индексирование баз данных применяем для всех случаев, когда число операций чтения больше операций на запись:
...
## Итоговый дизайн системы Первого уровня
...
![изображение](https://github.com/trofimovelijah/System-Design/assets/15788014/48ba89ab-979c-4315-a915-72c106eaa94a)
