...
## Высокоуровневый дизайн
![изображение](https://github.com/trofimovelijah/System-Design/assets/15788014/f2bc8f2b-bc9f-470f-9e05-95fb63e634cc)
...
5. Сервис рекомендаций Recommendation service требует быстрый доступ к данным, для чего можно использовать Redis.
...
3. Инфраструктура машинного обучения:
