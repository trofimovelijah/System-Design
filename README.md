...
2. Сервис поиска и фильтрации GeoSearch service:
   ...
   - индексирует анкеты  с помощью атрибутов геолокации и предпочтений.

## Высокоуровневый дизайн
![изображение](https://github.com/trofimovelijah/System-Design/assets/15788014/c5593a62-a03b-4a40-9890-f6f32d8af781)

## Хранилища и базы данных
1. Location service определяет услуги геолокации, для который наиболее оптимален подход квадродерево QuadTree:
...
2. Сервис поиска и фильтрации GeoSearch service использует подход GeoHash:
   - для быстрого запроса и фильтрации можно использовать Elasticsearch,
