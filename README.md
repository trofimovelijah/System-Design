# Первый уровень: Базовый дизайн MVP
## Функциональные требования
1. Профили пользователей: Пользователи могут создавать, сохранять и редактировать свои профили.
2. Нравится / не нравится: пользователям могут нравиться или не нравиться профили.
3. Соответствие: Когда два пользователя нравятся друг другу, они подходят друг другу и могут начать разговор.
4. Уведомления: Пользователи получают уведомления о совпадениях и сообщениях.
5. Медиаконтент: Пользователи могут загружать фотографии и короткие видеоролики.
6. Чат в режиме реального времени: Совпадающие пользователи могут общаться в режиме реального времени.
...
- Медиа-контент: Распределенное хранилище файлов (например, Amazon S3)
- Сообщения в чате: База данных NoSQL (например, MongoDB)
4. Кэширование: Кэширование в памяти (например, Redis) для часто используемых данных.
5. Балансировка нагрузки: Распределяйте трафик с помощью балансировщиков нагрузки (например, Nginx, AWS ELB).
