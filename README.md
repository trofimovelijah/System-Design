...
## Высокоуровневый дизайн
![изображение](https://github.com/trofimovelijah/System-Design/assets/15788014/42908629-62d7-4ce9-a60c-362c5fe18116)

## Хранилища и базы данных
1. Location service определяет услуги геолокации<strike>, для который наиболее оптимален подход квадродерево QuadTree</strike>:
...
2. Сервис поиска и фильтрации GeoSearch service использует для быстрого запроса и фильтрации ElasticSearch:
